...
/**
 * Tests for {@link Lcom4Calculator} — LCOM4 metric and connected-components
 * algorithm.
 *
 * <p>
 * Fixtures are chosen to hit the three canonical cases: fully cohesive (1), two
 * isolated groups (2), and a god class with three groups (≥ 3).
 */
class Lcom4CalculatorTest {
	 ...
	 * Group 1 (order): validate, persist. Group 2 (mailer): sendConfirmation,
	 * sendReceipt. Expected LCOM4 = 2.
	 */
	...
	/**
	 * God class: three completely isolated method groups, one per field. Group 1
	 * (userRepo): findUser, saveUser. Group 2 (emailService): sendWelcome,
	 * sendAlert. Group 3 (reportEngine): exportPdf, exportCsv. Expected LCOM4 = 3.
	 */
