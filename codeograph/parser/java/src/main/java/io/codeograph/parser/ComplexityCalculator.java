 ...
 *
 * <p>All methods are stateless and thread-safe. Inputs are JavaParser AST nodes;
 * no JSON I/O occurs here.
 *
 * <p>Metrics implemented:
 * <ul>
...
final class ComplexityCalculator {
    ...
    /**
     * Physical lines of code for a method (begin to end inclusive).
     * Includes blank lines and comments — coarse size proxy.
     */
