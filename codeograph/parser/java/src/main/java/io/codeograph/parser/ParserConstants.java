 ...
 *
 * <p>All string lists are first-match-wins ordered where order matters
...
final class ParserConstants {
     ...
     */
    static final List<String> STEREOTYPES = List.of(
    ...
    static final List<String> CONSTRAINT_ANNOTATIONS = List.of(
